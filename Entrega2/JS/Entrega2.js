...
const creditos = [
    ...
    { id: 3, nombre: "Post-grado",    tipo: "estudio",  montoMax: 2800000,  interes: 1.04},
    { id: 4, nombre: "Maestria",      tipo: "estudio",  montoMax: 3200000,  interes: 1.06},
    { id: 5, nombre: "Carro",         tipo: "vehiculo", montoMax: 20000000, interes: 1.09},
    { id: 6, nombre: "Moto",          tipo: "vehiculo", montoMax: 12000000, interes: 1.11},
    { id: 7, nombre: "Libre",         tipo: "libre",    montoMax: 5000000,  interes: 1.13}
];

// Variables
let activo = true, opcion, filtrar;
...
do {
    ...
    if (filtrar !== null) opcion2 = parseInt(prompt("Seleccione el crédito que desea adquirir:\n" + filtrar,""));
